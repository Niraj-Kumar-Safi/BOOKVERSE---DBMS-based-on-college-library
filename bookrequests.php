...
<br />
<br />
<p class="msg" align="center" colspan="2"><?php echo $msg;?></p> 
...
<td align="center"><?php echo $y['sname'];?></td><td align="center"><?php echo $y['sid'];?></td><td><a href="add.php?a=<?php echo $y['id'];?>" class="link">Remove</a></td></tr>
